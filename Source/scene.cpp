...
scene::scene()
{
    ...
    //DONE FLAT WALLS @ Y = 6 plane
    walls[14]= triangle(glm::vec3(0.0f, 6.0f, -5.0f), glm::vec3(0.0f, 6.0f, 5.0f), glm::vec3(10.0, 6.0, 5.0),colordbl(0.0, 1.0, 0.0), direction(0.0, -1.0, 0.0), vertex::DIFFUSE);
    walls[15]= triangle(glm::vec3(0.0f, 6.0f, -5.0f), glm::vec3(10.0f, 6.0f, 5.0f), glm::vec3(10.0, 6.0, -5.0),colordbl(0.0, 1.0, 0.0), direction(0.0, -1.0, 0.0), vertex::DIFFUSE);
